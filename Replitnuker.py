...
#CREDITS FOR ད𝔙𝔉ཌFear.#5468
CHANNEL_NAMES =  ["RETARD отвергнуть нацистов", "LMAO", "ХЕЙЛ В.Ф."]#you can change this
...
WEBHOOK_NAMES = ['WE OWN U','ICY','VICTOR', 'FEAR', 'HOMOPHOBIC','SAG','HAIL VF','HEIL VF']#you can skid this
#CREDITS FOR ད𝔙𝔉ཌFear.#5468
...
async def online(ctx):
    ...
    await ctx.message.delete() #dont edit
#CREDITS FOR ད𝔙𝔉ཌFear.#5468
@client.command()
@commands.is_owner()
...
token = os.getenv("token") #make a secret for ur bot token or wait for the new one without Secret
